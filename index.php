...
<body>
<center> <h2>Already registered? <a href="login_home.php">login</a> </h2></center>
...
<form name="form1" enctype="multipart/form-data" method="post" action="processing_file.php">
<table width="650" border="0" cellspacing="20">
  <tr>	
    <td class="label">Username*</td>
    <td><span id="sprytextfield1">
      <label for="username"></label>
      <input type="text" name="username"  class="spry" />
  ...
  <tr>
    ...
    <input type="text" name="phoneno" id="phoneno" class="spry" />
  ...
  <tr>
    ...
    <input type="text" name="email" id="email" class="spry"/>
    <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <label for="nokphoneno"></label>
    <input type="text" name="nokphoneno" class="spry" />
    <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
  </tr>
  <tr>
    ...
    <label for="dob"></label>
    <input type="text" name="dob" id="dob" class="spry"/>
    <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><span id="spryselect4">
      ...
      <select name="amount" class="spry">
        <option value="none">--Choose Payment--</option>
  ...
  <tr>
    ...
    <td><label for="picture"></label>
      <input type="file" name="picture" id="picture" class="spry" /></td>
  </tr>
  <tr>
    <td class="label">House Address*</td>
    <td><span id="sprytextarea1">
      <label for="houseaddress"></label>
...
var sprypassword1 = new Spry.Widget.ValidationPassword("sprypassword1", {maxChars:20, minChars:5, validateOn:["change"]});
